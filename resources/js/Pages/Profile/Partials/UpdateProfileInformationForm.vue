    ...
    <section>
        ...
        <form @submit.prevent="form.patch(route('profile.update'))" class="mt-6 space-y-6">
            <div>
                ...
                <TextInput id="fname" type="text" class="mt-1 block w-full" v-model="form.firstName" required autofocus autocomplete="First Name" />
                <InputError class="mt-2" :message="form.errors.firstName" />
            </div>
            <div>
                <InputLabel for="lname" value="Last Name" />
                <TextInput id="lname" type="text" class="mt-1 block w-full" v-model="form.lastName" required  autocomplete="Last Name" />
